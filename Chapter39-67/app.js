// ------------------  Chapter_38 to 42 (FUNCTIONS, SWITCH STATEMENTS, WHILE… DOWHILE LOOPS ) -----------------------------------
...
document.write (
  'The power of ' + num + ' raised to ' + powerNumber + ' is: ' + result
);
...
document.write (
  'The are of triangle whose sides are ' +
    a +
    ' , ' +
    b +
    ' , ' +
...
document.write (
  'Distance in centimeters is ' + centimeters (distance) + '<br>'
);
...
function overTime (time) {
  ...
  if (hour > 40) {
    ...
    document.write (
      'The over time pay of ' + extraHour + ' will be ' + extraPay
    );
  }
}
...
function currencyNotes (amount) {
  ...
  document.write (
    'You have' + '<br>' + ~~hundred + ' hundred rupess notes' + '<br>'
  );
